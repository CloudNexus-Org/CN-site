          ...
          <div className="lg:flex lg:items-center lg:gap-16">
            <div className="lg:flex-1">
              ...
              <p className="text-gray-300 max-w-2xl text-xl leading-relaxed mb-10">
                Real-time monitoring, predictive analytics and automation built
                for modern healthcare — scalable, secure and device-ready.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#customer-overview" className="group px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-teal-500 text-black font-bold shadow-2xl hover:shadow-cyan-500/25 hover:scale-105 transition-all duration-300 transform">
      ...
      <main className="max-w-7xl mx-auto px-6">
            ...
            <div className="lg:col-span-2 group">
              <div className="relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10 border border-white/20 rounded-3xl p-10 backdrop-blur-sm shadow-2xl hover:shadow-cyan-500/10 transition-all duration-500">
                ...
                <p className="text-gray-300 leading-relaxed text-lg relative z-10">
                  We partnered with a leading healthcare provider to deliver an
                  AI-driven monitoring & alerting platform using IoT sensors,
                  secure cloud pipelines, and real-time analytics to reduce risk
            ...
            <aside className="group">
              <div className="bg-gradient-to-br from-cyan-500/10 to-teal-500/10 border border-cyan-400/20 rounded-3xl p-8 backdrop-blur-sm shadow-xl hover:shadow-cyan-400/20 transition-all duration-500 h-full">
                ...
                <div className="space-y-3">
                  {["Healthcare", "IoT", "Data & Analytics"].map((industry, i) => (
        ...
        <section className="py-6">
          <div className="rounded-2xl border border-cyan-400/10 p-6 bg-gradient-to-b from-black/10 to-transparent">
            <p className="text-gray-200 italic text-center max-w-3xl mx-auto">
              “CloudNexus delivered a highly scalable, real-time monitoring
              platform that transformed patient care and operations.”
            </p>
        ...
        <section id="problems" className="py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Key challenges we addressed to deliver a comprehensive healthcare solution
            </p>
          </div>
        ...
        <section id="methodology" className="py-20">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full"></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Systematic approach to delivering innovative healthcare solutions
            </p>
          </div>
        ...
        <section id="services" className="py-20">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full"></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Comprehensive technology stack powering healthcare innovation
            </p>
          </div>
        ...
        <section id="roles" className="py-20 pb-32">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full"></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Specialized expertise driving healthcare technology innovation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "ML Engineer",
                description: "Develops and deploys machine learning models for predictive healthcare analytics and real-time decision support.",
                icon: "🧠",
                color: "from-cyan-500/20 to-cyan-400/10"
              },
              {
                title: "Cloud Engineer",
                description: "Architects and manages scalable, secure cloud infrastructure ensuring HIPAA compliance and high availability.",
                icon: "☁️",
                color: "from-teal-500/20 to-teal-400/10"
              },
              {
                title: "IoT Specialist",
                description: "Integrates medical devices and sensors, ensuring reliable data collection and device management at scale.",
                icon: "📡",
                color: "from-blue-500/20 to-blue-400/10"
              },
            ].map((r, i) => (
