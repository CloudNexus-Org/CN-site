// Filename: OurWorkRetail.jsx
// React component (Next.js client) refactor using Tailwind CSS + Framer Motion
...
// Theme variables (can be moved to a CSS file or Tailwind config)
// tailwind.config.js: extend colors if needed
...
export default function OurWorkRetail() {
  ...
  // Memoized static arrays to avoid re-renders
  const industries = useMemo(() => ["Retail", "E-commerce", "Data & Analytics"], []);
  ...
  const services = useMemo(
    () => [
      { title: "Data Analytics", description: "Advanced data processing and analytics platforms for retail intelligence.", icon: "📈", color: "from-cyan-500/20 to-cyan-400/10" },
      { title: "Machine Learning", description: "Custom ML models and algorithms for accurate demand forecasting.", icon: "🤖", color: "from-teal-500/20 to-teal-400/10" },
      { title: "Cloud Platform", description: "Scalable cloud infrastructure for real-time data processing and model serving.", icon: "☁️", color: "from-blue-500/20 to-blue-400/10" },
    ],
    []
  );
  ...
  const roles = useMemo(
    () => [
      { title: "Data Analyst", description: "Analyzes retail data patterns, builds forecasting models, and provides actionable insights for inventory optimization.", icon: "📊", color: "from-cyan-500/20 to-cyan-400/10" },
      { title: "ML Engineer", description: "Develops and deploys machine learning models for demand forecasting and real-time analytics.", icon: "🧠", color: "from-teal-500/20 to-teal-400/10" },
      { title: "Cloud Engineer", description: "Architects scalable cloud infrastructure for data processing and model serving at retail scale.", icon: "☁️", color: "from-blue-500/20 to-blue-400/10" },
    ],
    []
  );
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#02151a] via-[#071E24] to-black" aria-hidden="true" />
        <div className="absolute -left-32 top-16 w-[520px] h-[520px] rounded-full bg-gradient-to-r from-cyan-500/20 to-teal-400/10 blur-[160px] pointer-events-none animate-pulse" aria-hidden="true"></div>
        <div className="absolute right-32 bottom-16 w-[320px] h-[320px] rounded-full bg-cyan-400/5 blur-[120px] pointer-events-none" aria-hidden="true"></div>
          ...
          <div className="lg:flex lg:items-center lg:gap-16">
            <div className="lg:flex-1">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-4">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-teal-400 to-blue-400 animate-gradient-x font-black">powered by ML & Analytics</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#customer" className="group px-6 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-teal-500 text-black font-bold shadow-2xl hover:shadow-cyan-500/25 hover:scale-105 transition-transform duration-300 transform focus:outline-none focus:ring-4 focus:ring-cyan-400/20">
            ...
            <div className="mt-12 lg:mt-0 lg:w-[560px]">
              <motion.div whileHover={!shouldReduceMotion ? { scale: 1.02 } : {}} className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 to-teal-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500" aria-hidden></div>
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 bg-gradient-to-b from-black/20 to-transparent h-80 backdrop-blur-sm">
                  <img src="/image/retaill.jpeg" alt="Retail" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" decoding="async" width="1200" height="800" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" aria-hidden></div>
                </div>
              </motion.div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full" aria-hidden></div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <article className="relative overflow-hidden glass-card p-8 rounded-3xl border border-white/10 backdrop-blur-md shadow-lg hover:shadow-cyan-500/10 transition-shadow duration-400">
                <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-bl from-cyan-500/10 to-transparent rounded-full blur-2xl" aria-hidden></div>
        ...
        <section id="problems" className="py-20">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full" aria-hidden></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">Key challenges we addressed to deliver accurate demand forecasting solutions</p>
          </div>

          <div className="grid lg:grid-cols-4 gap-8">
            {problems.map((p, i) => (
              <motion.article key={i} whileHover={!shouldReduceMotion ? { scale: 1.03 } : {}} className="group relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6 transition-all duration-500">
                <div className={`absolute inset-0 bg-gradient-to-br ${p.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} aria-hidden></div>
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-400 to-teal-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" aria-hidden></div>
              </motion.article>
            ))}
          </div>
        </section>
        ...
        <section id="methodology" className="py-20">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full" aria-hidden></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">Systematic approach to delivering innovative retail forecasting solutions</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {methodology.map((s, i) => (
              <motion.article key={i} whileHover={!shouldReduceMotion ? { scale: 1.03 } : {}} className="group relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6 transition-all duration-500">
                <div className={`absolute inset-0 bg-gradient-to-br ${s.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} aria-hidden></div>
                <div className="relative z-10">
        ...
        <section id="services" className="py-20">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full" aria-hidden></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">Comprehensive technology stack powering retail innovation</p>
          </div>
        ...
        <section id="roles" className="py-20 pb-32">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full" aria-hidden></div>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">Specialized expertise driving retail technology innovation</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {roles.map((r, i) => (
              <motion.article key={i} whileHover={!shouldReduceMotion ? { scale: 1.03 } : {}} className="group relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl p-6 transition-all duration-500">
                <div className={`absolute inset-0 bg-gradient-to-br ${r.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} aria-hidden></div>
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-6">
      ...
      <div className="fixed right-6 bottom-6 z-50 flex flex-col gap-4">
        <a href="#customer" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/90 text-black font-semibold shadow-2xl focus:outline-none focus:ring-4 focus:ring-cyan-400/30">Read Case Study</a>
        <a href="#top" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/10 backdrop-blur-md" aria-label="Back to top">↑</a>
      </div>

      {/* Small CSS snippet for glass classes (add to global CSS or Tailwind layer) */}
      <style jsx global>{`
        .glass-card {
...
/*
Changelog (in-canvas):
- Preserved original logic (useLocalVisible & layout). Added prefers-reduced-motion handling via framer-motion.
- Memoized static arrays (industries, problems, methodology, services, roles) to avoid re-renders.
- Replaced repetitive inline "glass" styles with reusable CSS classes (.glass-card, .glass-card-2).
- Added Framer Motion for subtle entrance and hover animations (respects prefers-reduced-motion).
- Improved semantics and accessibility: aria-labelledby, aria-hidden where appropriate, focus rings for CTAs.
- Image improvements: added loading="lazy" and decoding="async" and width/height attributes for layout stability.
- Added sticky CTA and back-to-top affordances for better UX.
- Extracted motion variants and reduced JS work in render path.

Further recommendations (not implemented):
1. Move glass styles into a dedicated CSS module or Tailwind plugin; add variables to tailwind.config.js for brand colors.
2. Optimize images through a CDN or Next/Image component to serve WebP/AVIF and responsive sizes.
3. Add automated A11y checks, Lighthouse scoring, and SSR caching headers for the page.
*/
